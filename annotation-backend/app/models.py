...
class QuestionAnalysisAnnotation(Base):
    ...
    trigger_f3: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default='false')
    trigger_f4: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default='false')
    trigger_f5: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default='false')
    trigger_f6: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default='false')
